...
<?php include('require.php'); 
		if(!isset($_SESSION['pseudo'])) {header('Location: pageConnexion.php');}
?>
            ...
            <div class="u-header__section u-header__shadow-on-show-hide py-4 py-xl-0">
                <div id="logoAndNav" class="container-fluid py-xl-2 border-bottom-xl">
                    <nav class="js-mega-menu navbar navbar-expand-xl u-header__navbar u-header__navbar--no-space">
                        <a class="navbar-brand u-header__navbar-brand-default u-header__navbar-brand-center u-header__navbar-brand-text-dark-xl" href="index.php" aria-label="MyTour">
                            ...
                            <ul class="navbar-nav u-header__navbar-nav">
								<li class="nav-item hs-has-sub-menu u-header__nav-item" data-event="hover" data-animation-in="slideInUp" data-animation-out="fadeOut">
									...
									<ul id="homeSubMenu" class="hs-sub-menu u-header__sub-menu u-header__sub-menu-rounded u-header__sub-menu-bordered hs-sub-menu-right u-header__sub-menu--spacer" aria-labelledby="homeMenu" style="min-width: 230px;">
										<li><a class="nav-link u-header__sub-menu-nav-link" href="compte.php" onclick="page('1_monProfil', '');">Mon profil</a></li>
								...
								<li class="nav-item hs-has-sub-menu u-header__nav-item" data-event="hover" data-animation-in="slideInUp" data-animation-out="fadeOut">
									<a id="adminMenu" class="u-header__nav-link u-header__nav-link-toggle u-header__nav-link-border" href="javascript:;" aria-haspopup="true" aria-expanded="false" aria-labelledby="adminSubMenu">Gestion</a>
										<ul id="adminSubMenu" class="hs-sub-menu u-header__sub-menu u-header__sub-menu-rounded u-header__sub-menu-bordered hs-sub-menu-right u-header__sub-menu--spacer" aria-labelledby="adminMenu" style="min-width: 230px;">
											<?php if($_SESSION['role'] == 2 || $_SESSION['role'] == 3) { ?>
											<li><a class="nav-link u-header__sub-menu-nav-link" href="compte.php" onclick="page('3_gestionVol', 'vol=vide');">Gérer les vols</a></li>
											<?php } ?>
											<?php if($_SESSION['role'] == 2 || $_SESSION['role'] == 3) { ?>
											<li><a class="nav-link u-header__sub-menu-nav-link" href="compte.php" onclick="page('3_gestionDestination', 'destination=vide');">Gérer les destinations</a></li>
											<?php } ?>
											<?php if($_SESSION['role'] == 2 || $_SESSION['role'] == 4) { ?>
											<li><a class="nav-link u-header__sub-menu-nav-link" href="compte.php" onclick="page('3_gestionHotel', 'hotel=vide');">Gérer les hôtels</a></li>
											<?php } ?>
											<?php if($_SESSION['role'] == 2 || $_SESSION['role'] == 5) { ?>
											<li><a class="nav-link u-header__sub-menu-nav-link" href="compte.php" onclick="page('3_gestionLocation', 'locations=vide');">Gérer les locations</a></li>
											<?php } ?>
										</ul>
								</li>
								<?php } ?>
								...
								<li class="nav-item hs-has-sub-menu u-header__nav-item" data-event="hover" data-animation-in="slideInUp" data-animation-out="fadeOut">
									<a id="adminMenu" class="u-header__nav-link u-header__nav-link-toggle u-header__nav-link-border" href="javascript:;" aria-haspopup="true" aria-expanded="false" aria-labelledby="adminSubMenu">Admin</a>
										<ul id="adminSubMenu" class="hs-sub-menu u-header__sub-menu u-header__sub-menu-rounded u-header__sub-menu-bordered hs-sub-menu-right u-header__sub-menu--spacer" aria-labelledby="adminMenu" style="min-width: 230px;">
											<li><a class="nav-link u-header__sub-menu-nav-link" href="compte.php" onclick="page('2_listeCompte', '');">Gérer les utilisateurs</a></li>
										</ul>
								</li>
								<?php } ?>
                            </ul>
