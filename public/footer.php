		<footer class="bg-dark-1 footer">
            <div class="space-bottom-0 space-top-1">
                <div class="container">
                    <div class="row justify-content-xl-between">
                        <div class="col-12 col-lg-4 col-xl-3dot1 mb-6 mb-md-10 mb-xl-0">
                            <div class ="d-md-flex d-lg-block">
                                <div class="mb-5 mr-md-7 mr-lg-0">
                                    <h4 class="h6 mb-4 font-weight-bold text-white">Informations de contact</h4>
                                    <a>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <div class="mb-2 h6 font-weight-normal text-gray-10">Avez-vous une question ? Appelez-nous !</div>
                                                <small class="d-block font-size-18 font-weight-normal text-primary"><span class="text-primary font-weight-semi-bold">+32 494/15.22.34</span></small>
                                            </div>
                                        </div>
                                    </a>
                                </div>
                                <div class="ml-md-6 ml-lg-0">
                                    <div class="mb-4">
                                        <h4 class="h6 font-weight-bold mb-2 font-size-17 text-white">Informations de contact</h4>
                                        <address class="pr-4">
                                            <span class="mb-2 h6 font-weight-normal text-gray-10">
                                                Place Poelaert 1, </br> 1000 Bruxelles, Belgique
                                            </span>
                                        </address>
                                    </div>
                                </div>
                        ...
                        <div class="col-12 col-md-6 col-lg-4 col-xl-1dot8 mb-6 mb-md-10 mb-xl-0">
                            <h4 class="h6 font-weight-bold mb-2 mb-xl-4 text-white">Société</h4>
                            <ul class="list-group list-group-transparent list-group-white list-group-flush list-group-borderless mb-0">
                                <li><a class="text-decoration-on-hover list-group-item list-group-item-action" href="apropos.php">A propos de nous</a></li>
                                <li><a class="text-decoration-on-hover list-group-item list-group-item-action" href="contact.php">Contactez-nous</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            </div>
            <div class="border-top border-color-8 space-1">
                <div class="container">
                    <div class="row d-block d-xl-flex align-items-md-center">
                        <div class="col-xl-4 mb-4 mb-xl-0">
                            <!-- Logo -->
                            <a class="d-inline-flex align-items-center" href="index.php" aria-label="Front">
								<svg
								...
								<span class="brand brand-primary">Landing</span>
							</a>
                            <!-- End Logo -->
                        </div>
            ...
            <div class="space-1">
                <div class="container">
                    <div class="d-lg-flex d-md-block justify-content-between align-items-center">
                        <p class="text-muted mb-3 mb-lg-0 text-white">© 2022 Landing. Site à but éducatif pour un travail scolaire.</p>
                    </div>
                </div>
            </div>
        </footer>